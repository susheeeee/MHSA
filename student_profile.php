...
<head>
    ...
    <title>My Profile • <?= htmlspecialchars($fullname) ?></title>
    ...
    <style>
        ...
        .profile-header-info .student-id {
            font-size: 14px;
            opacity: 0.85;
            display: flex;
            align-items: center;
...
<div class="navbar">
    <div class="left-group" style="display:flex;align-items:center;gap:12px">
        ...
        <div id="profileDropdown" class="profile-dropdown" aria-hidden="true">
            ...
            <a href="student_dashboard.php" class="profile-item">Dashboard</a>
            <a href="logout.php" class="profile-item">Log out</a>
        </div>
        <div class="logo">Student | <?= htmlspecialchars($fullname) ?></div>
    </div>
</div>
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" value="<?= val('email') ?>" placeholder="idnumber@slc-sflu.edu.ph">
                    </div>
                    <div class="form-group">
